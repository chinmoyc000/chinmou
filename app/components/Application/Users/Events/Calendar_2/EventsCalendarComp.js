...
import { ScheduleComponent, Day, Week, WorkWeek, Month, Year, TimelineViews, TimelineMonth, TimelineYear, ViewsDirective, ViewDirective, ResourcesDirective, ResourceDirective, Inject, Resize, DragAndDrop, Agenda, Print, ICalendarImport, ICalendarExport, Timezone } from '@syncfusion/ej2-react-schedule';
...
export class EventsCalendarComp extends SampleBase {
    ...
    timelineTemplate() {
        return (<div style={{ height: '46px', lineHeight: '23px' }}>
        <div className='icon-child' style={{ textAlign: 'center' }}>
          <SwitchComponent id='timeline_views' checked={false} change={(args) => {
    ...
    multiDragTemplate() {
        return (<div style={{ height: '46px', lineHeight: '23px' }}>
        <div className='icon-child' style={{ textAlign: 'center' }}>
          <SwitchComponent id='multi_drag' checked={false} change={(args) => { this.scheduleObj.allowMultiDrag = args.checked; }}/>
        </div>
    ...
    groupTemplate() {
        return (<div style={{ height: '46px', lineHeight: '23px' }}>
        <div className='icon-child' style={{ textAlign: 'center' }}>
          <SwitchComponent id='grouping' checked={true} change={(args) => { this.scheduleObj.group.resources = args.checked ? ['Calendars'] : []; }}/>
        </div>
    ...
    gridlineTemplate() {
        return (<div style={{ height: '46px', lineHeight: '23px' }}>
        <div className='icon-child' style={{ textAlign: 'center' }}>
          <SwitchComponent id='gridlines' checked={true} change={(args) => { this.scheduleObj.timeScale.enable = args.checked; }}/>
        </div>
    ...
    autoHeightTemplate() {
        return (<div style={{ height: '46px', lineHeight: '23px' }}>
        <div className='icon-child' style={{ textAlign: 'center' }}>
          <SwitchComponent id='row_auto_height' checked={false} change={(args) => { this.scheduleObj.rowAutoHeight = args.checked; }}/>
        </div>
    ...
    tooltipTemplate() {
        return (<div style={{ height: '46px', lineHeight: '23px' }}>
        <div className='icon-child' style={{ textAlign: 'center' }}>
          <SwitchComponent id='tooltip' checked={false} change={(args) => { this.scheduleObj.eventSettings.enableTooltip = args.checked; }}/>
        </div>
    ...
    getResourceData(data) {
        ...
        let resourceData = resources.dataSource.filter((resource) => resource.CalendarId === data.CalendarId)[0];
        return resourceData;
    }
    ...
    contentTemplate(props) {
        ...
        {props.elementType === 'cell' ?
            ...
            <div className="content-area">
              <DropDownListComponent id="eventType" ref={(ddl) => this.eventTypeObj = ddl} dataSource={this.calendarCollections} fields={{ text: "CalendarText", value: "CalendarId" }} placeholder="Choose Type" index={0} popupHeight="200px"/>
            </div>
            <div className="content-area">
        ...
        <div className='col-lg-12 control-section'>
          <div className='content-wrapper'>
                ...
                <div className='overview-titlebar'>
                  ...
                  <div className='right-panel'>
                    ...
                    <div className='control-panel' style={{ display: 'inline-flex', paddingLeft: '15px' }}>
                      ...
                      <UploaderComponent id='fileUpload' type='file' allowedExtensions='.ics' cssClass='calendar-import' buttons={{ browse: 'Import' }} multiple={false} showFileList={false} selected={(this.onImportClick.bind(this))}/>
                    </div>
                    <div className='control-panel'>
              ...
              <div className='overview-content'>
                <div className='left-panel'>
                  <div className='overview-scheduler'>
                    <ScheduleComponent id='scheduler' cssClass='schedule-overview' ref={(schedule) => this.scheduleObj = schedule} width='100%' height='100%' group={{ resources: ['Calendars'] }} timezone='UTC' eventSettings={{ dataSource: generateEvents() }} quickInfoTemplates={{
            ...
            footer: this.footerTemplate.bind(this)
                    ...
                    <ContextMenuComponent id='ContextMenu' cssClass='schedule-context-menu' ref={(menu) => this.contextMenuObj = menu} target='.e-schedule' items={this.contextMenuItems} beforeOpen={(args) => {
            ...
            switch (selectedMenuItem) {
                ...
                case 'AddRecurrence':
                    ...
                    let activeCellsData = this.scheduleObj.getCellDetails(this.targetElement) ||
                  ...
                  <div className='control-panel e-css'>
                    <div className='col-row'>
                      ...
                      <div className='col-right'>
                        <DropDownListComponent id="weekFirstDay" width={170} dataSource={this.weekDays} fields={{ text: 'text', value: 'value' }} value={0} popupHeight={150} change={(args) => { this.scheduleObj.firstDayOfWeek = args.value; }}/>
                      </div>
                    </div>
                    <div className='col-row'>
                      <div className='col-left'>
                      ...
                      <div className='col-right'>
                        <MultiSelectComponent id="workWeekDays" cssClass='schedule-workweek' width={170} dataSource={this.weekDays} mode='CheckBox' fields={{ text: 'text', value: 'value' }} enableSelectionOrder={false} showClearButton={false} showDropDownIcon={true} popupHeight={150} value={[1, 2, 3, 4, 5]} change={(args) => this.scheduleObj.workDays = args.value}>
                    ...
                    <div className='col-row'>
                      ...
                      <div className='col-right'>
                        <MultiSelectComponent id="resources" cssClass='schedule-resource' width={170} dataSource={this.calendarCollections} mode='CheckBox' fields={{ text: 'CalendarText', value: 'CalendarId' }} enableSelectionOrder={false} showClearButton={false} showDropDownIcon={true} popupHeight={150} value={[1]} change={this.onResourceChange.bind(this)}>
                          <Inject services={[CheckBoxSelection]}/>
                        </MultiSelectComponent>
                      </div>
                    </div>
                    <div className='col-row'>
                      ...
                      <div className='col-right'>
                        <DropDownListComponent id="timezone" width={170} dataSource={this.timezoneData} fields={{ text: 'text', value: 'value' }} value='Etc/GMT' popupHeight={150} change={(args) => {
            ...
            document.querySelector('.schedule-overview #timezoneBtn').innerHTML =
                '<span class="e-btn-icon e-icons e-schedule-timezone e-icon-left"></span>' + args.itemData.text;
                    ...
                    <div className='col-row'>
                      ...
                      <div className='col-right'>
                        <TimePickerComponent id='dayStartHour' width={170} showClearButton={false} value={new Date(new Date().setHours(0, 0, 0))} change={(args) => this.scheduleObj.startHour = this.intl.formatDate(args.value, { skeleton: 'Hm' })}/>
                      </div>
                    </div>
                    <div className='col-row'>
                      <div className='col-left'>
                      ...
                      <div className='col-right'>
                        <TimePickerComponent id='dayEndHour' width={170} showClearButton={false} value={new Date(new Date().setHours(23, 59, 59))} change={(args) => this.scheduleObj.endHour = this.intl.formatDate(args.value, { skeleton: 'Hm' })}/>
                      </div>
                    </div>
                    <div className='col-row'>
                      <div className='col-left'>
                      ...
                      <div className='col-right'>
                        <TimePickerComponent id='workHourStart' width={170} showClearButton={false} value={new Date(new Date().setHours(9, 0, 0))} change={(args) => this.scheduleObj.workHours.start = this.intl.formatDate(args.value, { skeleton: 'Hm' })}/>
                      </div>
                    </div>
                    <div className='col-row'>
                      <div className='col-left'>
                      ...
                      <div className='col-right'>
                        <TimePickerComponent id='workHourEnd' width={170} showClearButton={false} value={new Date(new Date().setHours(18, 0, 0))} change={(args) => this.scheduleObj.workHours.end = this.intl.formatDate(args.value, { skeleton: 'Hm' })}/>
                      </div>
                    </div>
                    <div className='col-row'>
                      <div className='col-left'>
                      ...
                      <div className='col-right'>
                        <DropDownListComponent id="slotDuration" width={170} dataSource={this.majorSlotData} fields={{ text: 'Name', value: 'Value' }} value={60} popupHeight={150} change={(args) => { this.scheduleObj.timeScale.interval = args.value; }}/>
                      </div>
                    </div>
                    <div className='col-row'>
                      <div className='col-left'>
                      ...
                      <div className='col-right'>
                        <DropDownListComponent id="slotInterval" width={170} dataSource={this.minorSlotData} value={2} popupHeight={150} change={(args) => { this.scheduleObj.timeScale.slotCount = args.value; }}/>
                      </div>
                    </div>
                    <div className='col-row'>
                      <div className='col-left'>
                      ...
                      <div className='col-right'>
                        <DropDownListComponent id="timeFormat" width={170} dataSource={this.timeFormatData} fields={{ text: 'Name', value: 'Value' }} value={"hh:mm a"} popupHeight={150} change={(args) => { this.scheduleObj.timeFormat = args.value; }}/>
                      </div>
                    </div>
                    <div className='col-row'>
                      <div className='col-left'>
                      ...
                      <div className='col-right'>
                        <DropDownListComponent id="weekNumber" width={170} dataSource={this.weekNumberData} fields={{ text: 'Name', value: 'Value' }} value={"Off"} popupHeight={150} change={(args) => {
            if (args.value == "Off") {
